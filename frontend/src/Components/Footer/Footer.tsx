  ...
  return (
    <footer className="w-screen container p-8">
      <div className=" mx-auto p-3 w-full flex flex-col md:flex-row justify-around gap-5">
        ...
        <div className="border md:w-[373px] rounded-xl flex flex-col items-center justify-center p-5">
        ...
        <div className="hidden md:flex border md:w-[373px] rounded-xl  flex-col items-center justify-center p-5 relative">
          <img
            src={logo}
            alt=""
            className="absolute w-[74px] bg-black -top-10"
